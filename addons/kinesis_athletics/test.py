...
class test(osv.osv):
    ...
    _columns = {
        ...
        'rating_below_minimum': fields.selection([(u'alert', u'Alert'), (u'ideal', u'Ideal'), (u'superior', u'Superior')], string='Rating Below Minimum'),
        'rating_over_maximum': fields.selection([(u'alert', u'Alert'), (u'ideal', u'Ideal'), (u'superior', u'Superior')], string='Rating Over Maximum'),
