...
class test(osv.osv):
    ...
    _columns = {
        ...
        'rating_below_minimum': fields.selection([(u'alert', u'Alert'), (u'ideal', u'Ideal'), (u'superior', u'Superior'), (u'none', u'None')], string='Rating Below Minimum'),
        'rating_over_maximum': fields.selection([(u'alert', u'Alert'), (u'ideal', u'Ideal'), (u'superior', u'Superior'), (u'none', u'None')], string='Rating Over Maximum'),
        'invert': fields.boolean(string='Invert'),
        'rating_between': fields.selection([(u'alert', u'Alert'), (u'ideal', u'Ideal'), (u'superior', u'Superior'), (u'none', u'None')], string='Rating Between'),
